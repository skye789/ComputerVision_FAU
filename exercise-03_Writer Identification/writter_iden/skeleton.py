...
# 一张图片有多个sift，一个sift基于局部区域得到descriptors；clusters相当于另一张图的不同sift
...
if __name__ == '__main__':
    ...
    args.__setattr__('labels_train', 'icdar17_labels_train.txt')
    args.__setattr__('labels_test', 'icdar17_labels_test.txt')
    ...
    if not os.path.exists('mus.pkl.gz'):
        # TODO
        descriptors = loadRandomDescriptors(files_train, max_descriptors=100000)
